...
export const useAuthorizeCheckout = () => {
  ...
  const checkout = async (paymentDetails: any) => {
    ...
    try {
      ...
      overlay.innerHTML = `
        <div class="relative w-full max-w-xl bg-white rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
          ...
          <div id="authnet-iframe-container" class="w-full h-[450px] relative">
